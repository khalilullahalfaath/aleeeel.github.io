...
* Tips from the book: 
  ...
  1. Skim the chapter first. Note something that is important (appears multiple times throughout the section)
  2. Ask questions
  3. Read through carefully. Always start with the statement; the proof later, if we like.
  4. Be active. This should include checking the text and doing the exercises. Never trust the author!
  5. Always reflect
